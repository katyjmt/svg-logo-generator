...
class Text {
    ...
    render() {
        return `<text x="${this.textPositionX}" y="${this.textPositionY}" fill="${this.textColour}" text-anchor="${this.textAnchor}" dominant-baseline="${this.textDominantBaseline}">${this.text}</text>`
    }
}
